...
export default function Results() {
  return (
    <div className="mx-5 my-64">
      <h1 className="text-[50px] font-kanit tracking-tight leading-[60px] mt-36">
      ...
      <div className="flex md:flex-row flex-col-reverse gap-24 my-44">
        ...
        <div className="w-[90%]">
          <p className="text-white-600 md:text-4xl text-2xl md:leading-[70px] leading-[24px] mb-5 md:mb-20 md:ml-[-220px] font-kanit">
            <LinearGradient gradient={["to right", "#fdde00 ,#ffffff"]}>Brandroot Media - Your Online Creative Hub</LinearGradient>
          </p>
          <h1 className="md:text-[30px] md:text-[40px] text-2xl font-kanit tracking-normal md:leading-[20px] md:leading-[42px]">
          ...
          <p className="md:text-2xl text-1xl my-2 font-kanit mt-5 ">
      ...
      <div>
        ...
        <TwoCardsEffect
          rotate1={"-rotate-[1deg]"}
          rotate2={"rotate-[1deg]"}>
          <h1 className="text-xl md:text-4xl font-kanit text-center py-10 px-2 md:px-0 text-white">
            Brandroot Media Agency - Guaranteed Results or Your Money Back!
          </h1>
        </TwoCardsEffect>
