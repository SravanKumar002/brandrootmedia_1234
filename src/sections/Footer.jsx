  ...
  return (
    <div id="contactus" className="w-full flex flex-col items-start md:items-center">
      ...
      <div className="flex md:flex-row flex-col items-start md:gap-10">
        <button className="md:my-10 bg-gradient-to-br from-yellow-500 to-white-600 text-black font-semibold px-7 py-2.5 md:text-2xl text-xl rounded">
          Book Call
        </button>
        <button className="my-10 bg-gradient-to-br from-yellow-500 to-white-600 text-black font-semibold px-7 py-2.5 md:text-2xl text-xl rounded">
          Chat On Whatsapp
        </button>
      </div>
      <div className="w-screen relative right- bg-gradient-to-br from-yellow-500 to-white-600 flex py-8 items-center h-16 md:h-full justify-center gap-20 ">
